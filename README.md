<!-- 배너 -->
<img src="assets/banner_dark.svg" alt="조진경 포트폴리오 배너" width="100%">

---

## 👋 소개
안녕하세요! 프론트엔드/AI 분야에 관심이 많은 개발자 **조진경**입니다.  
작게는 HTML/CSS/JS로 만드는 인터랙티브 웹, 크게는 AI 데모와 로봇 프로젝트까지 **보이는 결과물**에 집착합니다.  
- GitHub: https://github.com/susie1214  
- Contact: (원하면 이메일/링크 추가)
